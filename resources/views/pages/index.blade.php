...
@section('content')
    ...
    <section class="recreation-types">
        <div class="recreation-types_wrapper headline headline-3 cont">
        <h3>Виды отдыха &#8594;</h3>
         @include ('components.pictogram-line.pictogram-line')
        </div>
    </section>

    <section class="recommendations cont headline headline-2 ">
        <div class="section-headlines">
        <h3>Colorlife рекомендует</h3>
    ...
    <section class="hot-tours cont headline headline-2 ">
